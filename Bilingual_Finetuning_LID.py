...
model_number = "12"
model_name = "wav2vec2_fy_pl_LID_common_voice_"
...
base_url_train = "/data/common_voice_17_germanic/train_fy_pl/"
base_url_validation = "/data/common_voice_17_germanic/validation_fy_pl/"
base_url_test = "/data/common_voice_17_germanic/test_fy_pl/"
...
def filter_function(example):
    ...
    return example['lid'] in ['fy-NL','pl']
...
vocab_dict["[PL]"] = len(vocab_dict)
#vocab_dict["[HI]"] = len(vocab_dict)
#vocab_dict["[UR]"] = len(vocab_dict)
# DE NL EN
...
#prepared_data_directory_train = "/data/prepared_data/train"
#prepared_data_directory_validation = "/data/prepared_data/validation"
